...
// Click the image using the TestObject
WebUI.click(trexImage)

// Verify the click was successful - check if image is still present
WebUI.verifyElementPresent(trexImage, 5)
