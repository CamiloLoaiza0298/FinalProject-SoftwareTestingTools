...
if (width >= 768) {
    ...
    WebUI.comment('Desktop layout verified: Web navigation visible, mobile navigation hidden') // Tablet/Mobile: expect mobile navigation visible
} else {
...
WebUI.verifyElementNotPresent(new TestObject().addProperty('xpath', ConditionType.EQUALS, '//body[contains(@style,\'overflow-x\')]'), 
