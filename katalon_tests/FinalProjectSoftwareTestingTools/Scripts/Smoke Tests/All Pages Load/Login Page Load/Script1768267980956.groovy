...
WebUI.navigateToUrl('http://localhost:8000/login.html')
...
WebUI.verifyElementVisible(findTestObject('Page_Login/input_Show password_toggle-pass'))

WebUI.verifyElementVisible(findTestObject('Page_Login/button_Login'))

WebUI.verifyElementVisible(findTestObject('Page_Login/button_Register'))
